# Getting Started with Better Ollama

This guide will help you install and set up the Better Ollama custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com/constructorfleet/hacs-better-ollama`
6. Set category to "Integration"
7. Click "Add"
8. Find "Better Ollama" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com/constructorfleet/hacs-better-ollama/releases)
2. Extract the `ollama` folder from the archive
3. Copy it to `custom_components/ollama/` in your Home Assistant configuration directory
...
4. Select entities from "Better Ollama"
...
- [GitHub Discussions](https://github.com/constructorfleet/hacs-better-ollama/discussions)
