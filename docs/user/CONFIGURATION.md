...
This document describes all configuration options and settings available in the Better Ollama custom integration.
...
```yaml
service: ollama.example_service
target:
...
- [GitHub Issues](https://github.com/constructorfleet/hacs-better-ollama/issues) - Report problems
