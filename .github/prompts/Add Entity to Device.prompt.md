...
- Inherit from `OllamaEntity` and platform base class
...
- Entity: `custom_components/ollama/[platform]/[entity_name].py`
- Platform: `custom_components/ollama/[platform]/__init__.py`
