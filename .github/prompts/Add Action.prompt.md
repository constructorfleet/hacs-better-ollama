...
**File:** `custom_components/ollama/services.yaml`
...
Create `custom_components/ollama/service_actions/[action_name].py`:

```python
"""[Action name] service action for Better Ollama."""
...
**File:** `custom_components/ollama/__init__.py`
...
**File:** `custom_components/ollama/const.py`
...
3. Find service action: `ollama.[action_name]`
...
- **Domain:** `ollama`
- **Service actions directory:** `custom_components/ollama/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/ollama/services.yaml` (legacy filename)
- **Icons:** `custom_components/ollama/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/ollama/translations/*.json` under `services` key (legacy)
