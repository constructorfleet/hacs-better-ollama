...
- Create new sensor file in `custom_components/ollama/sensor/`
- Inherit from `OllamaEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Better Ollama."""
...
class Ollama[SensorName]Sensor(
    OllamaEntity,
    SensorEntity,
):
...
- Entity: `custom_components/ollama/sensor/[sensor_name].py`
- Platform: `custom_components/ollama/sensor/__init__.py`
- Translations: `custom_components/ollama/translations/*.json`
