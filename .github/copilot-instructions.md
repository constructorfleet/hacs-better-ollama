...
- `entity/` - Base entity class (`OllamaEntity`)
...
- All entities inherit: `(PlatformEntity, OllamaEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.ollama: debug` in `config/configuration.yaml`
