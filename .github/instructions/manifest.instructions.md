...
**Applies to:** `custom_components/ollama/manifest.json`
...
```json
{
  ...
  "config_flow": true,
  "documentation": "https://github.com/constructorfleet/hacs-better-ollama",
  "integration_type": "device",
  "iot_class": "cloud_polling",
  "issue_tracker": "https://github.com/constructorfleet/hacs-better-ollama/issues",
  "requirements": [],
  "version": "0.0.0"
}
```
