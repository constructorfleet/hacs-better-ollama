...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `Ollama`
...
- Inherit from both platform entity and `OllamaEntity` (order matters)
...
from custom_components.ollama.sensor import async_setup_entry
...
**Config entry data:** `entry_data: OllamaData = hass.data[DOMAIN][entry.entry_id]`
