...
class OllamaBaseLLMEntity(Entity):
    ...
    async def _async_handle_chat_log(
        ...
        message_history: MessageHistory = MessageHistory([_convert_content(content) for content in chat_log.content])
        ...
        for _iteration in range(MAX_TOOL_ITERATIONS):
            try:
                ...
                raise HomeAssistantError(f"Sorry, I had a problem talking to the Ollama server: {err}") from err
